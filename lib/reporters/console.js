...
function console (config, metrics) {
	...
	function formatTable () {
		var totalTime = build[0].duration;

		var longestTaskName = _.reduce(tasks, function (result, task) {
		...
		var tableData = _.reduce(tasks, function (result, task) {
			var average = task.duration / totalTime;
